...
- **Trois zones** depuis le 2026-08-17 : la barre du haut (périmètre + niveau de regroupement) vaut pour les graphiques *et* le tableau ; la carte de réglages décrit la **forme** du pivot (lignes, colonnes, tri, coupures) ; une barre plate juste au-dessus du tableau porte ce qui choisit son **contenu** (colonnes, filtres, affichage des pourcentages), sur le motif de ConnectedFeed.
