...
| Creative Insights Verisure (VERISURE) | Note supprimée le 2026-08-03 | Hajar + Léonie | POC client jamais travaillé par Adam. Le sujet est devenu le module plateforme [[1.Projects/MINE_CreativeInsights/Creative Insights]], qui lui **est** un projet actif d'Adam (lead). |
